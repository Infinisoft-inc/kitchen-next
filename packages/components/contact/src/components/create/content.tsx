...
const Category = React.lazy(() => import(/* webpackPrefetch: false */ /* webpackChunkName: 'Category' */ './steps/category'))
const Subcategory = React.lazy(() => import(/* webpackPrefetch: false */ /* webpackChunkName: 'SubCategory' */ './steps/subcategory'))
const ContactInformation = React.lazy(() => import(/* webpackPrefetch: false */ /* webpackChunkName: 'ContactInformation' */ './steps/contactinformation'))
const Relations = React.lazy(() => import(/* webpackPrefetch: false *//* webpackChunkName: 'Relations' */ './steps/relations'))
